...
└── context/
    ...
    ├── after.json                     v6 — after all five features landed
    ├── v1.json … v6.json              Every version, complete
...
relationships / 30 metrics (v6) as each feature table landed, with the 23 new
metric names listed and the conflicts the Context Agent detected rather than
silently resolved.

## Still to be added

- `06_*/` — the sealed sixth-spec bundle (schema, insights, trace)
